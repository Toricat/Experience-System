...
Revision ID: 283e1b3dc4d4
Revises: 
Create Date: 2024-09-05 17:00:36.336803
...
def upgrade() -> None:
    ...
    sa.Column('id_provider', sa.String(length=225), nullable=True),
    ...
    op.create_index(op.f('ix_user_id_provider'), 'user', ['id_provider'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('item')
    op.drop_index(op.f('ix_user_id_provider'), table_name='user')
